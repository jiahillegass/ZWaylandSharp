using static ZWaylandSharpGen.WlCommonIdentifiers;
using static ZWaylandSharpGen.Client.WlClientIdentifiers;
using ZWaylandSharpGen.Xml;

namespace ZWaylandSharpGen.Client;
